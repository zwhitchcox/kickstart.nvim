...
-- Diff options - disable word-level highlighting, just show line-level
vim.opt.diffopt = { 'filler', 'vertical', 'algorithm:histogram' }
...
require('lazy').setup({
  ...
  -- LSP Plugins
  {
    ...
    config = function()
      ...
      -- Ensure file watching is explicitly enabled (fixes LSP caching issues for external changes)
